  ...
  return (
    <Box sx={{ height: 'auto', margin: 2 }}>
      ...
      <Box sx={{ display: 'flex', margin: 2 }} >
        ...
        <Card sx={{ dispaly: 'flex', maxWidth: 1000, bgcolor: 'green' }}>
          <Box square={true} sx={{ display: 'flex', flexDirection: 'column' }}>
            <CardActionArea sx={{ width: '100%', height: '100%', bgcolor: 'yellow' }}>
              <CardMedia
                component='img'
                image={banner}
                alt='banner picture'
                ...
                sx={{ bgcolor: 'yellow' }}
              />
              <div style={{ zIndex: 100, position: 'absolute', color: 'white', left: 0,  bottom: 0, width: 350, padding: 10 }}>
